...
sudo sysctl -p
sudo apt-get update
sudo apt-get install git subversion build-essential autoconf automake flex bison rpcbind pypy libsqlite3-dev python-dev pypy-dev unzip python-crypto libgmp-dev
...
git clone https://github.com/darka/p2pfs.git
