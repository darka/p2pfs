...
% describe what happens when a node joins the network
% when a node changes a file in the network
% see what happens

% why is chord better than pastry? - routing performance is the same, implementation is simpler
