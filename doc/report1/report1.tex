...
Currently there is clear consensus in the literature on what distributed file system components lead to achieving the best possible performance. In fact the most common benchmark used to test such file systems, the Andrew benchmark, has itself received a lot of criticism due to some reasons (what?). Designing a superior benchmark is however out of scope of this project, and would in fact prevent any attempt to compare this file system with other file systems.
